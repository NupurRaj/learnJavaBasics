...
public class CalculatorTest3 {
	...
	public void add0Test() {
		System.out.println("**Running method addTest0 in testfile CalculatorTest3.java");
		Assert.assertEquals(10, calc.add1(4, 6));
		System.out.println("**Completed addTest0 method run..");
	}

  @Test(priority = 1, groups = "AdditionTests")
